...
function analizadorReservada(texto, a) {
    ...
    let aceptaciones = "si,sino,hacer,falso,cadena,entero,decimal,mientras,staticiable,booleano,verdadero,funcion,principal,retornar,vacio,caracter,para,imprimir";
